# The following region of code was retrieved from https://gallery.technet.microsoft.com/scriptcenter/Grant-Revoke-Query-user-26e259b0
# and was written by Tony Pombo for managing user rights assignments. I have stripped out the code for modifying user rights, leaving
